        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Interpretative Dance Scores - Second Judge</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $secondJudgeQuery = "SELECT `jdg_id` FROM `judge` ORDER BY `jdg_id` ASC LIMIT 1 OFFSET 1";
                                    $secondJudgeResult = mysqli_query($conn, $secondJudgeQuery);
                                    
                                    if ($secondJudgeResult && mysqli_num_rows($secondJudgeResult) > 0) {
                                        $secondJudgeRow = mysqli_fetch_assoc($secondJudgeResult);
                                        $second_judge_id = $secondJudgeRow['jdg_id'];
                                        ...
                                        if ($stmt = mysqli_prepare($conn, $query)) {
                                            mysqli_stmt_bind_param($stmt, 'i', $second_judge_id);
