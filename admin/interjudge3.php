        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Interpretative Dance Scores - Third Judge</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    // Query to get the ID of the third judge
                                    ...
                                    if ($thirdJudgeResult && mysqli_num_rows($thirdJudgeResult) > 0) {
                                        ...
                                        // Query to get interpretative dance scores for the third judge
